    ...
    public partial class dp2MessageHandler : MessageHandler<dp2MessageContext>
    {
        ...
        public override IResponseMessageBase OnEvent_ClickRequest(RequestMessageEvent_Click requestMessage)
        {
            try
            {
                ...
                {
                    case dp2WeiXinConst.ACTION_Search: //"Search":
                        {
                    ...
                    case dp2WeiXinConst.ACTION_BorrowInfo:// "BorrowInfo":
                        {
                            this.CurrentMessageContext.CurrentAction = dp2WeiXinConst.ACTION_BorrowInfo;
                            reponseMessage = this.ReplyMyMessage(requestMessage.FromUserName);
                            break;
                        }
                    case dp2WeiXinConst.ACTION_Renew:// "Renew":
                        {
